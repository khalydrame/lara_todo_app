                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900"><?php echo e(__('Create')); ?> Todo</h1>
                            <p class="mt-2 text-sm text-gray-700">Add a new <?php echo e(__('Todo')); ?>.</p>
                        </div>
                    ...
                    <div class="flow-root">
                        <div class="mt-8 overflow-x-auto">
                            <div class="max-w-xl py-2 align-middle">
                                <form method="POST" action="<?php echo e(route('todos.store')); ?>"  role="form" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /www/wwwroot/todo-app.khalydrame.com/todo-app/resources/views/todos/create.blade.php ENDPATH**/ ?>